...
export default function Navbar(){
  ...
  return(<header className="sticky top-0 z-40 bg-white/80 backdrop-blur border-b border-slate-200">
    <div className="container-lg py-4 md:py-5 flex items-center justify-between">
      <Link href="/" className="flex items-center">
        <Image src="/Logo.png" alt="Home Market Consulting" width={260} height={56} className="hidden md:block h-14 w-auto" priority/>
        <Image src="/Logoresponsive.png" alt="HMC" width={40} height={40} className="md:hidden h-11 w-auto" priority/>
      </Link>
