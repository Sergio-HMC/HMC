      ...
      <div className="container-lg grid md:grid-cols-3 gap-8 items-start">
        <div className="flex items-center md:items-start gap-3">
          <div className="hidden md:block">
            <Image src="/Logo.png" alt="Home Market Consulting" width={220} height={48} className="h-12 w-auto" />
          </div>
          <div className="md:hidden">
            <Image src="/Logoresponsive.png" alt="Home Market Consulting" width={40} height={40} className="h-10 w-auto" />
          </div>
        </div>
