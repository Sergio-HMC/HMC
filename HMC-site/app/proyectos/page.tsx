    ...
    <main className="bg-white">
      <section className="py-12 border-b border-slate-200/70">
        <div className="container-lg">
          ...
          <p className="mt-3 text-slate-700 max-w-3xl">Galería de proyectos y antes/después. Reemplaza cada imagen por tus fotos reales.</p>
        </div>
      </section>
      <section className="py-14">
        <div className="container-lg grid sm:grid-cols-2 md:grid-cols-3 gap-6">
          {imgs.map((src, idx)=> (
            <div key={src} className="card overflow-hidden">
              <div className="relative aspect-[4/3]">
                <Image src={src} alt={`REEMPLAZAR ACA POR IMAGEN ${(idx+2).toString().padStart(2,"0")}`} fill className="object-cover" />
              </div>
